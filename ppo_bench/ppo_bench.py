...
def make_env(gym_name, seed, idx, capture_video, run_name):
    def thunk():
...
if __name__ == "__main__":
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env("Hopper-v5", args.seed + i, i, args.capture_video, run_name) for i in range(args.num_envs)]
    )
